						...
						<div class="text-inner">
							<div class="row">
								<div class="col-lg-7 col-12">
									<div class="hero-text">
										<h1><span>UP TO 50% OFF </span>Best of bests</h1>
										<p>Find the best products at the best prices</p>
										<div class="button">
											<a href="{{ route('site.products') }}" class="btn">Shop Now!</a>
										</div>
									</div>
								</div>
							</div>
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-12">
					<div class="single-banner">
						...
						<div class="content">
							<p>{{ $product->name }}</p>
							<h3>{{ $product->slug }} <br>Up to<span> 50%</span></h3>
							<a href="{{ route('site.product', $product->id) }}">Shop Now</a>
						</div>
					</div>
				</div>
				@endforeach
