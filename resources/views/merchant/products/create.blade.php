                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative mt-1 rounded-md shadow-sm">
                                <x-text-input id="price" class="block w-full pl-3 pr-12" type="number" step="0.01"
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="short_description" name="short_description"
                                class="block w-full mt-1 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                rows="2"
                                placeholder="A brief description of the product">{{ old('short_description') }}</textarea>
