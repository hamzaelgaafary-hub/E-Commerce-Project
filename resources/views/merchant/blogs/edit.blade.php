<x-merchant-layout>
    ...
    <div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
            <h2 class="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-6">Edit blog</h2>
            <form method="POST" action="{{ route('blogs.update', $blog) }}" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="price" class="block w-full mt-1" type="number" step="0.01" name="price"
                                :value="old('price', $blog->price)" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="qty" class="block w-full mt-1" type="number" name="qty" :value="old('qty', $blog->qty)" required />
                            <x-input-error :messages="$errors->get('qty')" class="mt-2" />
                        </div>

                        <!-- Trending blog -->
                        <div>
                            <x-input-label for="trend" :value="__('Trending blog')" />
                            <select id="trend" name="trend"
                                class="block w-full mt-1 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                <option value="0" {{ old('trend', $blog->trend) == 0 ? 'selected' : '' }}>No</option>
                                <option value="1" {{ old('trend', $blog->trend) == 1 ? 'selected' : '' }}>Yes</option>
                            </select>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex items-center">
                                <img id="image-preview" src="{{ asset('storage/' . $blog->image) }}" alt="Image"
                            ...
                            <input id="image" class="block w-full mt-2 text-sm text-gray-500
                                ...
                                hover:file:bg-indigo-100" type="file" name="image"
                        ...
                        <div>
                            ...
                            <textarea id="short_description" name="short_description" rows="3"
                                class="block w-full mt-1 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                placeholder="A brief description of the blog">{{ old('short_description', $blog->short_description) }}</textarea>
                ...
                <!-- Form Actions -->
                <div
                    class="flex items-center justify-end mt-8 space-x-4 pt-6 border-t border-gray-200 dark:border-gray-700">
