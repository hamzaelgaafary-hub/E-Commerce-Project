                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('index') }}">
                        <img src="{{ asset('site/images/logo.png') }}"
                            class="w-20 h-20 fill-current shadow-md overflow-hidden rounded-full text-gray-500"
                            alt="logo" style="width: 130px; height: 60px;">
